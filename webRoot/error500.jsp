...
div.panel
{
   ...
   <title>ShelvesTech Secure Document Storage &raquo; System Error</title>
</head>
<body>
   <div>
      <br/>
      <img src="${pageContext.request.contextPath}/res/themes/shelvesTechTheme/images/app-logo.png">
      <br/>
      <br/>
      ...
      <br/>
      <br/>
      <a href="http://www.shelvestech.in">ShevlesTech</a>. &copy; 2015 All rights reserved.
   </div>
   <div>
<%
out.println("<!--");
