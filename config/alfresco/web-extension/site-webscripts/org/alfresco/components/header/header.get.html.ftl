   ...
   <@uniqueIdDiv>
      ...
      <div class="header">
         <span class="header-left">
            <span class="logo">
               <a href="${url.context}"><img src="${url.context}<#if logo?? && logo?length!=0>/proxy/alfresco/api/node/${logo?replace('://','/')}/content<#else>/res/themes/${theme}/images/${defaultlogo}</#if>" alt="ShelvesTech DMS" /></a>
            </span>
      ...
      <div class="header">
         <span class="header-left">
            <span class="logo">
               <a href="#" onclick="${jsid}.showAboutShare(); return false;"><img src="${url.context}/res/themes/${theme}/images/${logo!"app-logo.png"}" alt="ShelvesTech DMS" /></a>
            </span>
            <span class="logo-spacer">&nbsp;</span>
         </span>
      </div>
